...
export const commands = {
  async updateFormatMenuState(enabled: boolean): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_format_menu_state', { enabled }),
      };
    } catch (e) {
  ...
  async readFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('read_file', { filePath, projectRoot }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async writeFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('write_file', {
          filePath,
          content,
          projectRoot,
        }),
  ...
  async createFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_file', {
          directory,
          filename,
          content,
          projectRoot,
  ...
  async deleteFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_file', { filePath, projectRoot }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async renameFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('rename_file', {
          oldPath,
          newPath,
          projectRoot,
        }),
  ...
  async copyFileToAssets(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('copy_file_to_assets', {
          sourcePath,
          projectPath,
          collection,
          currentFilePath,
  ...
  async copyFileToAssetsWithOverride(
    sourcePath: string,
    projectPath: string,
    collection: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('copy_file_to_assets_with_override', {
          sourcePath,
          projectPath,
          collection,
          assetsDirectory,
  ...
  async parseMarkdownContent(
    filePath: string,
    projectRoot: string,
  ): Promise<Result<MarkdownContent, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('parse_markdown_content', {
          filePath,
          projectRoot,
        }),
      };
  ...
  async updateFrontmatter(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_frontmatter', {
          filePath,
          frontmatter,
          projectRoot,
        }),
  ...
  async saveMarkdownContent(
    filePath: string,
    frontmatter: Partial<{ [key in string]: JsonValue }> | null,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('save_markdown_content', {
          filePath,
          frontmatter,
          rawFrontmatter,
          content,
  ...
  async saveRecoveryData(data: JsonValue): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('save_recovery_data', { data }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async saveCrashReport(report: JsonValue): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('save_crash_report', { report }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async writeAppDataFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('write_app_data_file', { filePath, content }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async readAppDataFile(filePath: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('read_app_data_file', { filePath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async readFileContent(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('read_file_content', {
          filePath,
          projectRoot,
        }),
      };
  ...
  async writeFileContent(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('write_file_content', {
          filePath,
          content,
          projectRoot,
        }),
  ...
  async createDirectory(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_directory', { path, projectRoot }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getRelativePath(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_relative_path', {
          filePath,
          projectPath,
          currentFilePath,
          useRelativePaths,
  ...
  async resolveImagePath(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('resolve_image_path', {
          imagePath,
          projectRoot,
          currentFilePath,
        }),
  ...
  async selectProjectFolder(): Promise<Result<string | null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('select_project_folder'),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async scanProject(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_project', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async scanProjectWithContentDir(
    projectPath: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_project_with_content_dir', {
          projectPath,
          contentDirectory,
        }),
      };
  ...
  async scanCollectionFiles(
    collectionPath: string,
  ): Promise<Result<FileEntry[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_collection_files', { collectionPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async loadFileBasedCollection(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('load_file_based_collection', {
          projectPath,
          collectionName,
        }),
      };
  ...
  async readJsonSchema(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('read_json_schema', {
          projectPath,
          collectionName,
        }),
      };
  ...
  ): Promise<Result<DirectoryScanResult, string>> {
    try {
      return {
        status: 'ok',
   ...
   */
  async countCollectionFilesRecursive(
    collectionPath: string,
  ): Promise<Result<number, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('count_collection_files_recursive', {
          collectionPath,
        }),
      };
    } catch (e) {
   ...
   */
  async scanCollectionFilesRecursive(
    collectionPath: string,
    collectionName: string,
  ): Promise<Result<FileEntry[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_collection_files_recursive', {
          collectionPath,
          collectionName,
        }),
      };
  ...
  async startWatchingProject(
    projectPath: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('start_watching_project', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async startWatchingProjectWithContentDir(
    projectPath: string,
    contentDirectory: string | null,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('start_watching_project_with_content_dir', {
          projectPath,
          contentDirectory,
        }),
      };
  ...
  async stopWatchingProject(
    projectPath: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('stop_watching_project', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async openPreferencesFolder(): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('open_preferences_folder'),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async resetAllPreferences(): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('reset_all_preferences'),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async openPathInIde(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('open_path_in_ide', { ideCommand, filePath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async startPreview(projectPath: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('start_preview', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async scanMdxComponents(
    projectPath: string,
    mdxDirectory: string | null,
  ): Promise<Result<MdxComponent[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_mdx_components', {
          projectPath,
          mdxDirectory,
        }),
      };
  ...
  async fetchReleaseNotes(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('fetch_release_notes', {
          currentVersion,
          newVersion,
        }),
      };
  ...
  async gitStatus(projectPath: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('git_status', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async gitCommit(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('git_commit', { projectPath, message }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async gitPush(projectPath: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('git_push', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async gitPull(projectPath: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('git_pull', { projectPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
